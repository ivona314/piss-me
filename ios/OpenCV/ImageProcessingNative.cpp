...
#include "ImageProcessingNative.hpp"
using namespace cv;
using namespace std;
...
Mat ImageProcessingNative::detect_lane(Mat image) {
...
Mat ImageProcessingNative::filter_only_yellow_white(Mat image) {
...
Mat ImageProcessingNative::crop_region_of_interest(Mat image) {
...
Mat ImageProcessingNative::draw_lines(Mat image, vector<Vec4i> lines) {
...
Mat ImageProcessingNative::detect_edges(Mat image) {
